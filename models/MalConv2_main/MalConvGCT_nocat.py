...
class MalConvGCT(LowMemConvBase):
    ...
    def __init__(self, out_size=2, channels=128, window_size=256, stride=64, layers=1, embd_size=8, log_stride=None, low_mem=True):
    ...
    def processRange(self, x, gct=None):
        ...
        for conv_glu, linear_cntx, conv_share in zip(self.convs, self.linear_atn, self.convs_share):
            ...
            # Now we effectively apply sigma(x_t^T tanh(W c)).
